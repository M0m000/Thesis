...
class AttachmentTrajectory(Node):
    def __init__(self):
        ...
        self.declare_parameter('hook_type', 'a')
        self.hook_type = self.get_parameter('hook_type').get_parameter_value().string_value
        ...
        tool_pos = self.tcp_in_tfc_trans
        ...
        self.trajectory_2 = self.hook_geometrics_handler.plan_trajectory_with_fixed_orientation(hook_num = self.hook_num, end_ppoint = 8)
