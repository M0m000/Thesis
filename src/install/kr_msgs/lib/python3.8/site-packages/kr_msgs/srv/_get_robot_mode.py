...
class Metaclass_GetRobotMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from kr_msgs.srv import _get_robot_mode
...
class GetRobotMode(metaclass=Metaclass_GetRobotMode):
    from kr_msgs.srv._get_robot_mode import GetRobotMode_Request as Request
    from kr_msgs.srv._get_robot_mode import GetRobotMode_Response as Response
