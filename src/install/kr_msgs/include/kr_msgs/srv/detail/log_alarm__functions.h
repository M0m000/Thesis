...
#ifndef KR_MSGS__SRV__DETAIL__LOG_ALARM__FUNCTIONS_H_
#define KR_MSGS__SRV__DETAIL__LOG_ALARM__FUNCTIONS_H_
...
/// Initialize srv/LogAlarm message.
/**
...
/// Create srv/LogAlarm message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * kr_msgs__srv__LogAlarm_Request__init().
...
/// Destroy srv/LogAlarm message.
/**
 * It calls
 * kr_msgs__srv__LogAlarm_Request__fini()
...
/// Check for srv/LogAlarm message equality.
/**
...
/// Initialize array of srv/LogAlarm messages.
/**
...
/// Finalize array of srv/LogAlarm messages.
/**
 * It calls
 * kr_msgs__srv__LogAlarm_Request__fini()
...
/// Create array of srv/LogAlarm messages.
/**
 * It allocates the memory for the array and calls
 * kr_msgs__srv__LogAlarm_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/LogAlarm messages.
/**
 * It calls
 * kr_msgs__srv__LogAlarm_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/LogAlarm message array equality.
/**
...
/// Copy an array of srv/LogAlarm messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * kr_msgs__srv__LogAlarm_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kr_msgs
...
/**
 * It calls
 * kr_msgs__srv__LogAlarm_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_kr_msgs
...
/**
 * It allocates the memory for the array and calls
 * kr_msgs__srv__LogAlarm_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kr_msgs
...
/**
 * It calls
 * kr_msgs__srv__LogAlarm_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // KR_MSGS__SRV__DETAIL__LOG_ALARM__FUNCTIONS_H_
