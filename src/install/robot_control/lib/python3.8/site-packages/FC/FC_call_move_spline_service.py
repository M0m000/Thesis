...
from kr_msgs.srv import MoveSpline
from time import time

def call_move_spline_service(node: Node, pos, rot, ref, ttype, tvalue, bpoint, btype, bvalue, sync, orient, horizon):
    client = node.create_client(MoveSpline, '/kr/motion/move_spline')
