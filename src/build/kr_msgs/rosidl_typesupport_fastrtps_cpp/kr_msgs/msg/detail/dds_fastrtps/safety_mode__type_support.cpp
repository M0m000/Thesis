...
#include "kr_msgs/msg/detail/safety_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const kr_msgs::msg::SafetyMode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  kr_msgs::msg::SafetyMode & ros_message)
{
  // Member: val
  cdr >> ros_message.val;
...
{
  auto typed_message =
    static_cast<const kr_msgs::msg::SafetyMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kr_msgs::msg::SafetyMode *>(
    untyped_ros_message);
...
{
  return &kr_msgs::msg::typesupport_fastrtps_cpp::_SafetyMode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kr_msgs, msg, SafetyMode)() {
  return &kr_msgs::msg::typesupport_fastrtps_cpp::_SafetyMode__handle;
}
