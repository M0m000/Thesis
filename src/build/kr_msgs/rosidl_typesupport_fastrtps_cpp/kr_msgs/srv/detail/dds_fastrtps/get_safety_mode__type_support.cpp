...
#include "kr_msgs/srv/detail/get_safety_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const kr_msgs::srv::GetSafetyMode_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  kr_msgs::srv::GetSafetyMode_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const kr_msgs::srv::GetSafetyMode_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kr_msgs::srv::GetSafetyMode_Request *>(
    untyped_ros_message);
...
{
  return &kr_msgs::srv::typesupport_fastrtps_cpp::_GetSafetyMode_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kr_msgs, srv, GetSafetyMode_Request)() {
  return &kr_msgs::srv::typesupport_fastrtps_cpp::_GetSafetyMode_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_kr_msgs
cdr_serialize(
  const kr_msgs::srv::GetSafetyMode_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: mode
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  kr_msgs::srv::GetSafetyMode_Response & ros_message)
{
  // Member: mode
  ...
  size_t current_alignment)
{
  ...
  // Member: mode
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        kr_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SafetyMode(
...
{
  auto typed_message =
    static_cast<const kr_msgs::srv::GetSafetyMode_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<kr_msgs::srv::GetSafetyMode_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &kr_msgs::srv::typesupport_fastrtps_cpp::_GetSafetyMode_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kr_msgs, srv, GetSafetyMode_Response)() {
  return &kr_msgs::srv::typesupport_fastrtps_cpp::_GetSafetyMode_Response__handle;
}
...
{
  return &kr_msgs::srv::typesupport_fastrtps_cpp::_GetSafetyMode__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kr_msgs, srv, GetSafetyMode)() {
  return &kr_msgs::srv::typesupport_fastrtps_cpp::_GetSafetyMode__handle;
}
