...
static const _SetSystemFrame_Request_type_support_symbol_names_t _SetSystemFrame_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, SetSystemFrame_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, SetSystemFrame_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kr_msgs, srv, SetSystemFrame_Request)() {
  return &::kr_msgs::srv::rosidl_typesupport_c::SetSystemFrame_Request_message_type_support_handle;
}
...
static const _SetSystemFrame_Response_type_support_symbol_names_t _SetSystemFrame_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, SetSystemFrame_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, SetSystemFrame_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_kr_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kr_msgs, srv, SetSystemFrame_Response)() {
  return &::kr_msgs::srv::rosidl_typesupport_c::SetSystemFrame_Response_message_type_support_handle;
}
...
static const _SetSystemFrame_type_support_symbol_names_t _SetSystemFrame_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, SetSystemFrame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, SetSystemFrame)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, kr_msgs, srv, SetSystemFrame)() {
  return &::kr_msgs::srv::rosidl_typesupport_c::SetSystemFrame_service_type_support_handle;
}
