...
static const _ProgramRecovery_Request_type_support_symbol_names_t _ProgramRecovery_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, ProgramRecovery_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, ProgramRecovery_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kr_msgs, srv, ProgramRecovery_Request)() {
  return &::kr_msgs::srv::rosidl_typesupport_c::ProgramRecovery_Request_message_type_support_handle;
}
...
static const _ProgramRecovery_Response_type_support_symbol_names_t _ProgramRecovery_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, ProgramRecovery_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, ProgramRecovery_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_kr_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kr_msgs, srv, ProgramRecovery_Response)() {
  return &::kr_msgs::srv::rosidl_typesupport_c::ProgramRecovery_Response_message_type_support_handle;
}
...
static const _ProgramRecovery_type_support_symbol_names_t _ProgramRecovery_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, ProgramRecovery)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, ProgramRecovery)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, kr_msgs, srv, ProgramRecovery)() {
  return &::kr_msgs::srv::rosidl_typesupport_c::ProgramRecovery_service_type_support_handle;
}
