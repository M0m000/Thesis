...
static const _ConfigAnalogOutput_Request_type_support_symbol_names_t _ConfigAnalogOutput_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, ConfigAnalogOutput_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, ConfigAnalogOutput_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kr_msgs, srv, ConfigAnalogOutput_Request)() {
  return &::kr_msgs::srv::rosidl_typesupport_c::ConfigAnalogOutput_Request_message_type_support_handle;
}
...
static const _ConfigAnalogOutput_Response_type_support_symbol_names_t _ConfigAnalogOutput_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, ConfigAnalogOutput_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, ConfigAnalogOutput_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_kr_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kr_msgs, srv, ConfigAnalogOutput_Response)() {
  return &::kr_msgs::srv::rosidl_typesupport_c::ConfigAnalogOutput_Response_message_type_support_handle;
}
...
static const _ConfigAnalogOutput_type_support_symbol_names_t _ConfigAnalogOutput_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, ConfigAnalogOutput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, ConfigAnalogOutput)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, kr_msgs, srv, ConfigAnalogOutput)() {
  return &::kr_msgs::srv::rosidl_typesupport_c::ConfigAnalogOutput_service_type_support_handle;
}
