...
bool kr_msgs__msg__robot_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kr_msgs.msg._robot_pose.RobotPose", full_classname_dest, 33) == 0);
  }
  kr_msgs__msg__RobotPose * ros_message = _ros_message;
  {  // pos
...
PyObject * kr_msgs__msg__robot_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("kr_msgs.msg._robot_pose");
