...
#include "kr_msgs/srv/detail/get_robot_mode__rosidl_typesupport_fastrtps_c.h"
...
using _GetRobotMode_Request__ros_msg_type = kr_msgs__srv__GetRobotMode_Request;
...
size_t get_serialized_size_kr_msgs__srv__GetRobotMode_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetRobotMode_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_kr_msgs__srv__GetRobotMode_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kr_msgs
size_t max_serialized_size_kr_msgs__srv__GetRobotMode_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_kr_msgs__srv__GetRobotMode_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, GetRobotMode_Request)() {
...
#include "kr_msgs/msg/detail/robot_mode__functions.h"  // mode
...
using _GetRobotMode_Response__ros_msg_type = kr_msgs__srv__GetRobotMode_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kr_msgs
size_t get_serialized_size_kr_msgs__srv__GetRobotMode_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetRobotMode_Response__ros_msg_type * ros_message = static_cast<const _GetRobotMode_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_kr_msgs__srv__GetRobotMode_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kr_msgs
size_t max_serialized_size_kr_msgs__srv__GetRobotMode_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_kr_msgs__srv__GetRobotMode_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, GetRobotMode_Response)() {
...
// already included above
// #include "kr_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "kr_msgs/srv/get_robot_mode.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kr_msgs, srv, GetRobotMode)() {
