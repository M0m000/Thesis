...
action_interfaces__msg__UV__create()
{
  ...
  action_interfaces__msg__UV * msg = (action_interfaces__msg__UV *)allocator.allocate(sizeof(action_interfaces__msg__UV), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(action_interfaces__msg__UV));
  bool success = action_interfaces__msg__UV__init(msg);
  if (!success) {
...
action_interfaces__msg__UV__Sequence__init(action_interfaces__msg__UV__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_interfaces__msg__UV * data = NULL;

  if (size) {
    data = (action_interfaces__msg__UV *)allocator.zero_allocate(size, sizeof(action_interfaces__msg__UV), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = action_interfaces__msg__UV__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        action_interfaces__msg__UV__fini(&data[i - 1]);
      }
...
action_interfaces__msg__UV__Sequence__fini(action_interfaces__msg__UV__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      action_interfaces__msg__UV__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  action_interfaces__msg__UV__Sequence * array = (action_interfaces__msg__UV__Sequence *)allocator.allocate(sizeof(action_interfaces__msg__UV__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = action_interfaces__msg__UV__Sequence__init(array, size);
  if (!success) {
...
action_interfaces__msg__UV__Sequence__destroy(action_interfaces__msg__UV__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    action_interfaces__msg__UV__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
action_interfaces__msg__UV__Sequence__are_equal(const action_interfaces__msg__UV__Sequence * lhs, const action_interfaces__msg__UV__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!action_interfaces__msg__UV__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  action_interfaces__msg__UV__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(action_interfaces__msg__UV);
    action_interfaces__msg__UV * data =
      (action_interfaces__msg__UV *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!action_interfaces__msg__UV__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          action_interfaces__msg__UV__fini(&data[i]);
        }
        free(data);
        return false;
      }
