...
class Metaclass_SetAnalogOutput(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from kr_msgs.srv import _set_analog_output
...
class SetAnalogOutput(metaclass=Metaclass_SetAnalogOutput):
    from kr_msgs.srv._set_analog_output import SetAnalogOutput_Request as Request
    from kr_msgs.srv._set_analog_output import SetAnalogOutput_Response as Response
