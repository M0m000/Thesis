...
def process_hook_for_publisher(hook_name, hook_data, dual_camera_setup = False, publish_masks = True):
        ...
        if hook_data['hook_box'] is not None:
            ...
            if dual_camera_setup == True:
                hook.uv_tip_img2 = UV(u=hook_data['uv_hook_img2'][0], v = hook_data['uv_hook_img2'][1])
        ...
        if hook_data['tip_box'] is not None:
            ...
            if dual_camera_setup == True:
                hook.uv_tip_img2 = UV(u=hook_data['uv_tip_img2'][0], v = hook_data['uv_tip_img2'][1])
        ...
        if hook_data['lowpoint_box'] is not None:
            ...
            if dual_camera_setup == True:
                hook.uv_lowpoint_img2 = UV(u=hook_data['uv_lowpoint_img2'][0], v = hook_data['uv_lowpoint_img2'][1])
        return hook
