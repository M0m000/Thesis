...
#include "action_interfaces/srv/detail/generate_frame__type_support.h"
...
static void * action_interfaces__srv__generate_frame__request__create_ros_message(void)
{
  return action_interfaces__srv__GenerateFrame_Request__create();
}

static void action_interfaces__srv__generate_frame__request__destroy_ros_message(void * raw_ros_message)
{
  action_interfaces__srv__GenerateFrame_Request * ros_message = (action_interfaces__srv__GenerateFrame_Request *)raw_ros_message;
  action_interfaces__srv__GenerateFrame_Request__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool action_interfaces__srv__generate_frame__request__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * action_interfaces__srv__generate_frame__request__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(action_interfaces, srv, GenerateFrame_Request);

int8_t
_register_msg_type__srv__generate_frame__request(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&action_interfaces__srv__generate_frame__request__create_ros_message,
    NULL, NULL);
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__srv__generate_frame__request",
  ...
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&action_interfaces__srv__generate_frame__request__destroy_ros_message,
    NULL, NULL);
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__srv__generate_frame__request",
  ...
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&action_interfaces__srv__generate_frame__request__convert_from_py,
    NULL, NULL);
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__srv__generate_frame__request",
  ...
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&action_interfaces__srv__generate_frame__request__convert_to_py,
    NULL, NULL);
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__srv__generate_frame__request",
  ...
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(action_interfaces, srv, GenerateFrame_Request),
    NULL, NULL);
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__srv__generate_frame__request",
...
static void * action_interfaces__srv__generate_frame__response__create_ros_message(void)
{
  return action_interfaces__srv__GenerateFrame_Response__create();
}

static void action_interfaces__srv__generate_frame__response__destroy_ros_message(void * raw_ros_message)
{
  action_interfaces__srv__GenerateFrame_Response * ros_message = (action_interfaces__srv__GenerateFrame_Response *)raw_ros_message;
  action_interfaces__srv__GenerateFrame_Response__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool action_interfaces__srv__generate_frame__response__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * action_interfaces__srv__generate_frame__response__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(action_interfaces, srv, GenerateFrame_Response);

int8_t
_register_msg_type__srv__generate_frame__response(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&action_interfaces__srv__generate_frame__response__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__srv__generate_frame__response",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&action_interfaces__srv__generate_frame__response__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__srv__generate_frame__response",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&action_interfaces__srv__generate_frame__response__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__srv__generate_frame__response",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&action_interfaces__srv__generate_frame__response__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__srv__generate_frame__response",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(action_interfaces, srv, GenerateFrame_Response),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__srv__generate_frame__response",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, action_interfaces, srv, GenerateFrame)();

int8_t
_register_srv_type__srv__generate_frame(PyObject * pymodule)
{
  int8_t err;
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, action_interfaces, srv, GenerateFrame)(),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_srv__srv__generate_frame",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
PyInit_action_interfaces_s__rosidl_typesupport_introspection_c(void)
{
  ...
  err = _register_msg_type__srv__generate_frame__request(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }

  err = _register_msg_type__srv__generate_frame__response(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }

  err = _register_srv_type__srv__generate_frame(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }
