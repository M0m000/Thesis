...
{
  new (message_memory) kr_msgs::msg::SafetyMode(_init);
}

void SafetyMode_fini_function(void * message_memory)
{
  auto typed_message = static_cast<kr_msgs::msg::SafetyMode *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SafetyMode_message_member_array[1] = {
  {
    ...
    offsetof(kr_msgs::msg::SafetyMode, val),  // bytes offset in struct
...
{
  return &::kr_msgs::msg::rosidl_typesupport_introspection_cpp::SafetyMode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kr_msgs, msg, SafetyMode)() {
  return &::kr_msgs::msg::rosidl_typesupport_introspection_cpp::SafetyMode_message_type_support_handle;
}
