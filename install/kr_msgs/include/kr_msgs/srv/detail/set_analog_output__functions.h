...
#ifndef KR_MSGS__SRV__DETAIL__SET_ANALOG_OUTPUT__FUNCTIONS_H_
#define KR_MSGS__SRV__DETAIL__SET_ANALOG_OUTPUT__FUNCTIONS_H_
 ...
 * calls
 * kr_msgs__srv__SetAnalogOutput_Request__init().
...
/**
 * It calls
 * kr_msgs__srv__SetAnalogOutput_Request__fini()
 ...
 * kr_msgs__srv__SetAnalogOutput_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * kr_msgs__srv__SetAnalogOutput_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * kr_msgs__srv__SetAnalogOutput_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kr_msgs
...
/**
 * It calls
 * kr_msgs__srv__SetAnalogOutput_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_kr_msgs
...
/**
 * It allocates the memory for the array and calls
 * kr_msgs__srv__SetAnalogOutput_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kr_msgs
...
/**
 * It calls
 * kr_msgs__srv__SetAnalogOutput_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // KR_MSGS__SRV__DETAIL__SET_ANALOG_OUTPUT__FUNCTIONS_H_
