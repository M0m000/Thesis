...
{
  new (message_memory) kr_msgs::srv::GetProgramState_Request(_init);
}

void GetProgramState_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<kr_msgs::srv::GetProgramState_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetProgramState_Request_message_member_array[1] = {
  {
    ...
    offsetof(kr_msgs::srv::GetProgramState_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetProgramState_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(kr_msgs::srv::GetProgramState_Request),
...
{
  return &::kr_msgs::srv::rosidl_typesupport_introspection_cpp::GetProgramState_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kr_msgs, srv, GetProgramState_Request)() {
  return &::kr_msgs::srv::rosidl_typesupport_introspection_cpp::GetProgramState_Request_message_type_support_handle;
}
...
void GetProgramState_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) kr_msgs::srv::GetProgramState_Response(_init);
}

void GetProgramState_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<kr_msgs::srv::GetProgramState_Response *>(message_memory);
  typed_message->~GetProgramState_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember GetProgramState_Response_message_member_array[2] = {
  {
    "state",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(kr_msgs::srv::GetProgramState_Response, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(kr_msgs::srv::GetProgramState_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetProgramState_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(kr_msgs::srv::GetProgramState_Response),
...
{
  return &::kr_msgs::srv::rosidl_typesupport_introspection_cpp::GetProgramState_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kr_msgs, srv, GetProgramState_Response)() {
  return &::kr_msgs::srv::rosidl_typesupport_introspection_cpp::GetProgramState_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GetProgramState_service_members = {
  ...
  // see get_service_type_support_handle<kr_msgs::srv::GetProgramState>()
...
get_service_type_support_handle<kr_msgs::srv::GetProgramState>()
{
  ...
  auto service_type_support =
    &::kr_msgs::srv::rosidl_typesupport_introspection_cpp::GetProgramState_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kr_msgs, srv, GetProgramState)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<kr_msgs::srv::GetProgramState>();
}
