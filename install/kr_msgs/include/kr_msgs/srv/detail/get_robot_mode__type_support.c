...
#include <stddef.h>
#include "kr_msgs/srv/detail/get_robot_mode__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember GetRobotMode_Request__rosidl_typesupport_introspection_c__GetRobotMode_Request_message_member_array[1] = {
  {
    ...
    offsetof(kr_msgs__srv__GetRobotMode_Request, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers GetRobotMode_Request__rosidl_typesupport_introspection_c__GetRobotMode_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(kr_msgs__srv__GetRobotMode_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, GetRobotMode_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  kr_msgs__srv__GetRobotMode_Response__init(message_memory);
}

void GetRobotMode_Response__rosidl_typesupport_introspection_c__GetRobotMode_Response_fini_function(void * message_memory)
{
  kr_msgs__srv__GetRobotMode_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetRobotMode_Response__rosidl_typesupport_introspection_c__GetRobotMode_Response_message_member_array[2] = {
  {
    "mode",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(kr_msgs__srv__GetRobotMode_Response, mode),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(kr_msgs__srv__GetRobotMode_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GetRobotMode_Response__rosidl_typesupport_introspection_c__GetRobotMode_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(kr_msgs__srv__GetRobotMode_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_kr_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, GetRobotMode_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers kr_msgs__srv__detail__get_robot_mode__rosidl_typesupport_introspection_c__GetRobotMode_service_members = {
  "kr_msgs__srv",  // service namespace
  "GetRobotMode",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // kr_msgs__srv__detail__get_robot_mode__rosidl_typesupport_introspection_c__GetRobotMode_Request_message_type_support_handle,
  NULL  // response message
  // kr_msgs__srv__detail__get_robot_mode__rosidl_typesupport_introspection_c__GetRobotMode_Response_message_type_support_handle
};

static rosidl_service_type_support_t kr_msgs__srv__detail__get_robot_mode__rosidl_typesupport_introspection_c__GetRobotMode_service_type_support_handle = {
  0,
  &kr_msgs__srv__detail__get_robot_mode__rosidl_typesupport_introspection_c__GetRobotMode_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, GetRobotMode)() {
  if (!kr_msgs__srv__detail__get_robot_mode__rosidl_typesupport_introspection_c__GetRobotMode_service_type_support_handle.typesupport_identifier) {
    kr_msgs__srv__detail__get_robot_mode__rosidl_typesupport_introspection_c__GetRobotMode_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)kr_msgs__srv__detail__get_robot_mode__rosidl_typesupport_introspection_c__GetRobotMode_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, GetRobotMode_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kr_msgs, srv, GetRobotMode_Response)()->data;
  }

  return &kr_msgs__srv__detail__get_robot_mode__rosidl_typesupport_introspection_c__GetRobotMode_service_type_support_handle;
}
