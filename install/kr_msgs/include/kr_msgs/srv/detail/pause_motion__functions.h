...
#ifndef KR_MSGS__SRV__DETAIL__PAUSE_MOTION__FUNCTIONS_H_
#define KR_MSGS__SRV__DETAIL__PAUSE_MOTION__FUNCTIONS_H_
...
/// Initialize srv/PauseMotion message.
/**
...
/// Finalize srv/PauseMotion message.
/**
...
/// Create srv/PauseMotion message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * kr_msgs__srv__PauseMotion_Request__init().
...
/// Destroy srv/PauseMotion message.
/**
 * It calls
 * kr_msgs__srv__PauseMotion_Request__fini()
...
/// Check for srv/PauseMotion message equality.
/**
...
/// Copy a srv/PauseMotion message.
/**
...
/// Initialize array of srv/PauseMotion messages.
/**
...
/// Finalize array of srv/PauseMotion messages.
/**
 * It calls
 * kr_msgs__srv__PauseMotion_Request__fini()
...
/// Create array of srv/PauseMotion messages.
/**
 * It allocates the memory for the array and calls
 * kr_msgs__srv__PauseMotion_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PauseMotion messages.
/**
 * It calls
 * kr_msgs__srv__PauseMotion_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PauseMotion message array equality.
/**
...
/// Copy an array of srv/PauseMotion messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * kr_msgs__srv__PauseMotion_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kr_msgs
...
/**
 * It calls
 * kr_msgs__srv__PauseMotion_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_kr_msgs
...
/**
 * It allocates the memory for the array and calls
 * kr_msgs__srv__PauseMotion_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kr_msgs
...
/**
 * It calls
 * kr_msgs__srv__PauseMotion_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // KR_MSGS__SRV__DETAIL__PAUSE_MOTION__FUNCTIONS_H_
