...
kr_msgs__srv__GetRobotMode_Request__create()
{
  ...
  kr_msgs__srv__GetRobotMode_Request * msg = (kr_msgs__srv__GetRobotMode_Request *)allocator.allocate(sizeof(kr_msgs__srv__GetRobotMode_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(kr_msgs__srv__GetRobotMode_Request));
  bool success = kr_msgs__srv__GetRobotMode_Request__init(msg);
  if (!success) {
...
kr_msgs__srv__GetRobotMode_Request__destroy(kr_msgs__srv__GetRobotMode_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    kr_msgs__srv__GetRobotMode_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
kr_msgs__srv__GetRobotMode_Request__Sequence__init(kr_msgs__srv__GetRobotMode_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  kr_msgs__srv__GetRobotMode_Request * data = NULL;

  if (size) {
    data = (kr_msgs__srv__GetRobotMode_Request *)allocator.zero_allocate(size, sizeof(kr_msgs__srv__GetRobotMode_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = kr_msgs__srv__GetRobotMode_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        kr_msgs__srv__GetRobotMode_Request__fini(&data[i - 1]);
      }
...
kr_msgs__srv__GetRobotMode_Request__Sequence__fini(kr_msgs__srv__GetRobotMode_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      kr_msgs__srv__GetRobotMode_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  kr_msgs__srv__GetRobotMode_Request__Sequence * array = (kr_msgs__srv__GetRobotMode_Request__Sequence *)allocator.allocate(sizeof(kr_msgs__srv__GetRobotMode_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = kr_msgs__srv__GetRobotMode_Request__Sequence__init(array, size);
  if (!success) {
...
kr_msgs__srv__GetRobotMode_Request__Sequence__destroy(kr_msgs__srv__GetRobotMode_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    kr_msgs__srv__GetRobotMode_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
kr_msgs__srv__GetRobotMode_Request__Sequence__are_equal(const kr_msgs__srv__GetRobotMode_Request__Sequence * lhs, const kr_msgs__srv__GetRobotMode_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!kr_msgs__srv__GetRobotMode_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  kr_msgs__srv__GetRobotMode_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(kr_msgs__srv__GetRobotMode_Request);
    kr_msgs__srv__GetRobotMode_Request * data =
      (kr_msgs__srv__GetRobotMode_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kr_msgs__srv__GetRobotMode_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kr_msgs__srv__GetRobotMode_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!kr_msgs__srv__GetRobotMode_Request__copy(
...
kr_msgs__srv__GetRobotMode_Response__init(kr_msgs__srv__GetRobotMode_Response * msg)
{
  ...
  // mode
  if (!kr_msgs__msg__RobotMode__init(&msg->mode)) {
    kr_msgs__srv__GetRobotMode_Response__fini(msg);
    return false;
  }
  // success
  return true;
...
kr_msgs__srv__GetRobotMode_Response__fini(kr_msgs__srv__GetRobotMode_Response * msg)
{
  ...
  // mode
  kr_msgs__msg__RobotMode__fini(&msg->mode);
  // success
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  kr_msgs__srv__GetRobotMode_Response * msg = (kr_msgs__srv__GetRobotMode_Response *)allocator.allocate(sizeof(kr_msgs__srv__GetRobotMode_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(kr_msgs__srv__GetRobotMode_Response));
  bool success = kr_msgs__srv__GetRobotMode_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
kr_msgs__srv__GetRobotMode_Response__Sequence__init(kr_msgs__srv__GetRobotMode_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  kr_msgs__srv__GetRobotMode_Response * data = NULL;

  if (size) {
    data = (kr_msgs__srv__GetRobotMode_Response *)allocator.zero_allocate(size, sizeof(kr_msgs__srv__GetRobotMode_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = kr_msgs__srv__GetRobotMode_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        kr_msgs__srv__GetRobotMode_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
kr_msgs__srv__GetRobotMode_Response__Sequence__fini(kr_msgs__srv__GetRobotMode_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      kr_msgs__srv__GetRobotMode_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  kr_msgs__srv__GetRobotMode_Response__Sequence * array = (kr_msgs__srv__GetRobotMode_Response__Sequence *)allocator.allocate(sizeof(kr_msgs__srv__GetRobotMode_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = kr_msgs__srv__GetRobotMode_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
kr_msgs__srv__GetRobotMode_Response__Sequence__destroy(kr_msgs__srv__GetRobotMode_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    kr_msgs__srv__GetRobotMode_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
kr_msgs__srv__GetRobotMode_Response__Sequence__are_equal(const kr_msgs__srv__GetRobotMode_Response__Sequence * lhs, const kr_msgs__srv__GetRobotMode_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!kr_msgs__srv__GetRobotMode_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  kr_msgs__srv__GetRobotMode_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(kr_msgs__srv__GetRobotMode_Response);
    kr_msgs__srv__GetRobotMode_Response * data =
      (kr_msgs__srv__GetRobotMode_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kr_msgs__srv__GetRobotMode_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kr_msgs__srv__GetRobotMode_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!kr_msgs__srv__GetRobotMode_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
