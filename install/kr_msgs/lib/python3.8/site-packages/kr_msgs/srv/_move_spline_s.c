...
bool kr_msgs__srv__move_spline__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kr_msgs.srv._move_spline.MoveSpline_Request", full_classname_dest, 43) == 0);
  }
  kr_msgs__srv__MoveSpline_Request * ros_message = _ros_message;
  {  // pos
  ...
  {  // orient
    ...
    assert(PyLong_Check(field));
    ros_message->orient = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // horizon
    PyObject * field = PyObject_GetAttrString(_pymsg, "horizon");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->horizon = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of MoveSpline_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kr_msgs.srv._move_spline");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveSpline_Request");
  ...
  {  // orient
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->orient);
    {
  ...
  {  // horizon
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->horizon);
    {
      int rc = PyObject_SetAttrString(_pymessage, "horizon", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool kr_msgs__srv__move_spline__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kr_msgs.srv._move_spline.MoveSpline_Response", full_classname_dest, 44) == 0);
  }
  kr_msgs__srv__MoveSpline_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of MoveSpline_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kr_msgs.srv._move_spline");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveSpline_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
