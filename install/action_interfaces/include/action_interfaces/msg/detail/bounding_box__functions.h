...
#ifndef ACTION_INTERFACES__MSG__DETAIL__BOUNDING_BOX__FUNCTIONS_H_
#define ACTION_INTERFACES__MSG__DETAIL__BOUNDING_BOX__FUNCTIONS_H_
 ...
 * calls
 * action_interfaces__msg__BoundingBox__init().
...
/**
 * It calls
 * action_interfaces__msg__BoundingBox__fini()
 ...
 * action_interfaces__msg__BoundingBox__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * action_interfaces__msg__BoundingBox__Sequence__fini()
 * on the array,
...
#endif  // ACTION_INTERFACES__MSG__DETAIL__BOUNDING_BOX__FUNCTIONS_H_
