...
```bash
ros2 run vision yolov8_inference --ros-args -p yolo_model_path:="/home/mo/Thesis/YoloV8_InstanceSeg/models/20250110_2023_yolo8nano.pt" -p confidence_threshold:=0.4 -p do_preprocessing:=True -p do_postprocessing:=True -p show_cam_img:=True -p show_output_img:=True
```
